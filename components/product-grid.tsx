  ...
  return (
    <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-3 lg:col-span-10 lg:gap-x-8">
      {products.map((product) => (
        ...
        >
          <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-lg border-2 border-gray-200 bg-gray-100 group-hover:scale-105 transition-transform duration-300 dark:border-gray-800">
            <Image
              placeholder="blur"
